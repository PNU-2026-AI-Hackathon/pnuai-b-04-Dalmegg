  ...
  return (
    <button
      ...
      className={`w-full rounded-2xl border p-4 text-left transition ${
        selected
          ? 'border-rose-300 bg-rose-50/70 ring-2 ring-rose-100'
          : 'border-slate-100 bg-slate-50/70 hover:border-rose-200'
      }`}
    >
      ...
      <div className="mt-4 grid grid-cols-3 gap-2 text-xs">
        ...
        <span className="text-right font-bold text-rose-600">{zone.soilMoisture}%</span>
      </div>
    </button>
  )
}
