  ...
  return (
    <main className="grid min-h-screen place-items-center overflow-hidden bg-[#f3f8f3] px-5 py-16">
      <div className="relative w-full max-w-xl text-center">
        <div className="absolute left-1/2 top-1/2 -z-0 size-80 -translate-x-1/2 -translate-y-1/2 rounded-full bg-rose-200/40 blur-3xl" />
        <div className="relative">
          <div className="mx-auto grid size-20 place-items-center rounded-3xl bg-rose-700 text-white shadow-xl shadow-rose-200">
            <Sprout size={36} />
          </div>
          <p className="mt-8 text-sm font-black tracking-[0.2em] text-rose-700">404 NOT FOUND</p>
